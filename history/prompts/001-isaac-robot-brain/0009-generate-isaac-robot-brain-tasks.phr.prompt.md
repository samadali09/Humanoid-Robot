...
command: /sp.tasks
labels: [tasks, feature-development, isaac, robotics, ai, vslam, nav2]
links:
...
Successfully generated a detailed, dependency-ordered tasks list for the "AI-Robot Brain (NVIDIA Isaac™)" module.
...
- 📁 Files: Created tasks.md for feature 001-isaac-robot-brain.
